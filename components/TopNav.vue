<template>
  ...
  >
    ...
    >
      ...
      <div class="hidden md:flex items-cneter bg-[#f1f1f2] p-1 rounded-full max-w-[380px] w-full">
        <input 
          type="text" 
          class="w-full pl-3 my-2 bg-transparent placeholder-[#838383] text-[15px] focus:outline-none"
          placeholder="Search accounts"
        >
        <div class="px-3 py-1 flex items-center border-l-gray-300">
          ...
          <div class="relative">
            ...
            >
              <img 
                class="rounded-full"
                width="33"
                src="https://picsum.photos/id/83/300/320" alt="User Avatar">
            </button>
            ...
            >
              ...
              <div
                class="flex items-center justify-start py-3 px-1.5 hover:bg-gray-100 cursor-pointer border-t"
              >
